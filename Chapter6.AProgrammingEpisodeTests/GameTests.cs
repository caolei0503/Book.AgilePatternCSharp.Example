...
using Chapter6.AProgrammingEpisode;
using System;
...
namespace Chapter6.AProgrammingEpisode.Tests
{
    //[TestClass()]
    ...
    public class GameTests
    {
        ...
        public void TestTwoThrowsNoMark()
        {
            game.Add(5);
            game.Add(4);
            NUnit.Framework.Assert.AreEqual(9, game.Score);
        }
    }
}